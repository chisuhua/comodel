...
// D.i = signext(simm16).
void Instruction::S_MOVK_I32(ThreadItem *item)
{
	Register simm16;
	Register result;
...
//
void Instruction::S_CMPK_LE_U32(ThreadItem *item)
{
	ISAUnimplemented(item);
}

// D.i = D.i + signext(SIMM16). scc = overflow.
void Instruction::S_ADDK_I32(ThreadItem *item)
{
	Register simm16;
	Register sum;
	Register ovf;
...
// D.i = D.i * signext(SIMM16). scc = overflow.
void Instruction::S_MULK_I32(ThreadItem *item)
{
	Register simm16;
	Register product;
	Register ovf;
