...
// End the program.
void Instruction::S_EXIT(ThreadItem *item)
{
...
void Instruction::S_BRANCH(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
void Instruction::S_CBRANCH_SCC0(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
void Instruction::S_CBRANCH_SCC1(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
void Instruction::S_CBRANCH_VCCZ(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
// if(VCC == 0) then PC = PC + signext(SIMM16 * 4) + 4; else nop.
void Instruction::S_CBRANCH_VCCNZ(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
void Instruction::S_CBRANCH_EXECZ(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
// if(EXEC != 0) then PC = PC + signext(SIMM16 * 4) + 4; else nop.
void Instruction::S_CBRANCH_EXECNZ(ThreadItem *item)
{
	short simm16;
	int se_simm16;
...
void Instruction::S_BARRIER(ThreadItem *item)
{
...
void Instruction::S_WAITCNT(ThreadItem *item)
{
	// Nothing to do in emulation
	GetWarp->SetMemoryWait(true);
}

void Instruction::S_PHI(ThreadItem *item)
{
