...
#define opcode bytes.DS

void InstructionDS::Decode(uint64_t _opcode) {
    bytes.dword = _opcode;
    info.op = opcode.op;
    m_size = 8;
}
...
void Instruction::LOCAL_ADD_U32(ThreadItem *item)
{
...
void Instruction::LOCAL_INC_U32(ThreadItem *item)
{
	ISAUnimplemented(item);
}

// DS[ADDR+offset0*4] = D0; DS[ADDR+offset1*4] = D1; Write 2 Dwords
void Instruction::LOCAL_WRITE2_B32(ThreadItem *item)
{
	Register addr0;
	Register addr1;
	Register data0;
...
void Instruction::LOCAL_WRITE_B32(ThreadItem *item)
{
	Register addr;
	Register data0;
...
void Instruction::LOCAL_WRITE_B8(ThreadItem *item)
{
	Register addr;
	Register data0;
...
void Instruction::LOCAL_WRITE_B16(ThreadItem *item)
{
	Register addr;
	Register data0;
...
// R = DS[A]; Dword read.
void Instruction::LOCAL_READ_B32(ThreadItem *item)
{
	Register addr;
	Register data;
...
void Instruction::LOCAL_READ2_B32(ThreadItem *item)
{
	Register addr;
	Register data0;
	Register data1;
...
void Instruction::LOCAL_READ_I8(ThreadItem *item)
{
	Register addr;
	Register data;
...
void Instruction::LOCAL_READ_U8(ThreadItem *item)
{
	Register addr;
	Register data;
...
void Instruction::LOCAL_READ_I16(ThreadItem *item)
{
	Register addr;
	Register data;
...
void Instruction::LOCAL_READ_U16(ThreadItem *item)
{
	Register addr;
	Register data;
