...
// scc = (S0.i == S1.i).
void Instruction::S_CMP_EQ_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.i > S1.i).
void Instruction::S_CMP_GT_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.i >= S1.i).
void Instruction::S_CMP_GE_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.i < S1.i).
void Instruction::S_CMP_LT_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.i <= S1.i).
void Instruction::S_CMP_LE_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.u > S1.u).
void Instruction::S_CMP_GT_U32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.u >= S1.u).
void Instruction::S_CMP_GE_U32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// scc = (S0.u <= S1.u).
void Instruction::S_CMP_LE_U32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
