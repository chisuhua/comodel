...
void Instruction::S_ADD_U32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register sum;
...
void Instruction::S_ADD_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register sum;
...
// D.u = S0.i - S1.i. scc = overflow.
void Instruction::S_SUB_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register diff;
...
void Instruction::S_MIN_U32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register min;
...
void Instruction::S_MAX_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register max;
...
void Instruction::S_MAX_U32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register max;
...
// D.u = SCC ? S0.u : S1.u
void Instruction::S_CSELECT_B32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register scc;
...
void Instruction::S_AND_B32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// D.u = S0.u & S1.u. scc = 1 if result is non-zero.
void Instruction::S_AND_B64(ThreadItem *item)
{
...
// D.u = S0.u | S1.u. scc = 1 if result is non-zero.
void Instruction::S_OR_B32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// D.u = S0.u | S1.u. scc = 1 if result is non-zero.
void Instruction::S_OR_B64(ThreadItem *item)
{
	// Assert no literal constants for a 64 bit instruction.
	assert(!(opcode.ssrc0 == 0xFF || opcode.ssrc1 == 0xFF));
...
// D.u = S0.u ^ S1.u. scc = 1 if result is non-zero.
void Instruction::S_XOR_B64(ThreadItem *item)
{
	// Assert no literal constants for a 64 bit instruction.
	assert(!(opcode.ssrc0 == 0xFF || opcode.ssrc1 == 0xFF));
...
// D.u = S0.u & ~S1.u. scc = 1 if result is non-zero.
void Instruction::S_ANDN2_B64(ThreadItem *item)
{
	// Assert no literal constants for a 64 bit instruction.
	assert(!(opcode.ssrc0 == 0xFF || opcode.ssrc1 == 0xFF));
...
// D.u = ~(S0.u & S1.u). scc = 1 if result is non-zero.
void Instruction::S_NAND_B64(ThreadItem *item)
{
	// Assert no literal constants for a 64 bit instruction.
	assert(!(opcode.ssrc0 == 0xFF || opcode.ssrc1 == 0xFF));
...
void Instruction::S_LSHL_B32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// D.u = S0.u >> S1.u[4:0]. scc = 1 if result is non-zero.
void Instruction::S_LSHR_B32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
void Instruction::S_ASHR_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
// D.i = S0.i * S1.i.
void Instruction::S_MUL_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register result;
...
void Instruction::S_BFE_I32(ThreadItem *item)
{
	Register s0;
	Register s1;
	Register s2;
