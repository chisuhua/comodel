...
#define opcode bytes.FLAT

void InstructionFLAT::Decode(uint64_t _opcode) {
    bytes.dword = _opcode;
    info.op = opcode.op;
    bytes.word[1] = 0;
	m_size = 4;
...
void Instruction::FLAT_LOAD_DWORD(ThreadItem *item)
{
	// Record access
...
void Instruction::FLAT_LOAD_DWORDX2(ThreadItem *item)
{
	// Record access
	GetWarp->SetScalarMemoryRead(true);
...
void Instruction::FLAT_LOAD_DWORDX4(ThreadItem *item)
{
	// Record access
	GetWarp->SetScalarMemoryRead(true);
...
void Instruction::FLAT_STORE_DWORD(ThreadItem *item)
{
	// Record access
	GetWarp->SetScalarMemoryRead(true);
