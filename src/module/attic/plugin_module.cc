...
//}
tvm::runtime::Module CreateMyModule_(int value) {
   return tvm::runtime::Module(make_object<MyModuleNode>(value));
}
...
// TVM_DLL_EXPORT_PACKED_FUNC(CreateMyModule, CreateMyModule_);
